    ...
    <div className="space-y-4 pb-20">
      ...
      <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 border border-slate-800 rounded-3xl p-4 shadow-xl">
        <div className="space-y-2.5 mb-3">
          {/* Top Bar: Meeting Cashflow Badge & Month Quick-Switcher */}
          <div className="flex items-center justify-between gap-2">
            <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-400 bg-emerald-950/80 border border-emerald-800/50 px-2.5 py-0.5 rounded-full shrink-0">
              {t.meetingCashflow}
            </span>

            {/* Month Quick-Switcher Pill */}
            <div className="flex items-center gap-1 bg-slate-800/90 border border-slate-700/80 px-2 py-0.5 rounded-full text-[11px] font-bold text-slate-200 shrink-0">
              <button
                type="button"
                onClick={() => {
          ...
          {/* Amount & Action Buttons Row (Cleanly balanced, zero overflow) */}
          <div className="flex justify-between items-end gap-2 pt-0.5">
            <div>
              <div className="text-2xl font-black text-white leading-tight">
                {formatINR(stats.totalExpected)}
              </div>
              <span className="text-[11px] text-slate-400 block mt-0.5">{t.totalExpectedMonthlyCollection}</span>
            </div>

            <div className="flex items-center gap-1.5 shrink-0">
              <button
                onClick={onOpenFundManager}
                className="bg-slate-800 hover:bg-slate-700 text-slate-200 text-[11px] font-bold px-2.5 py-1.5 rounded-xl flex items-center gap-1 border border-slate-700 shadow transition active:scale-95 shrink-0"
              ...
              {isSuperAdmin && (
                <button
                  ...
                  className="bg-emerald-600 hover:bg-emerald-500 text-white text-[11px] font-bold px-2.5 py-1.5 rounded-xl flex items-center gap-1 shadow-lg shadow-emerald-900/30 active:scale-95 transition shrink-0"
